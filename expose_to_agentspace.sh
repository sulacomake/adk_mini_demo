export PROJECT_ID="genai-demos-avr-2024" # String 
export PROJECT_NUMBER="100140771040" # String 

export REASONING_ENGINE_ID="4854449389747306496" # String - Normally a 18-digit number
...
export AS_APP="atlas-agentspace_1745957652068" # String - Find it in Google Cloud AI Applications
export AS_LOCATION="global" # String - e.g. global, eu, us

export AGENT_DISPLAY_NAME="Agent_corp_brand" # String - this will appear as the name of the agent into your AgentSpace
